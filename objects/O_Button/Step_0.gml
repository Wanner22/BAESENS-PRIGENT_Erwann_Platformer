...
if distance_to_point(mouse_x, mouse_y) <= 0 and not gamepad_is_connected(0) is_selected = true;
else is_selected = false;

if gamepad_is_connected(0){ // Changer de bouton avec la manette
	if selected_id == button_id is_selected = true;
	...
	if check_up_button selected_id -= 1;
	if check_down_button selected_id += 1;
}
